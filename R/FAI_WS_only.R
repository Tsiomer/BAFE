#' FAI calculation
#'
#' This function generate FAI and rank from data of waterside
...
FAI_WS_only <- function(filepath = T){
    if(filepath){
    ...
    write.csv(merged_matric.2, file = "FAI_WS_matrix.csv", fileEncoding = "EUC-KR")
}
