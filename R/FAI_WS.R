...
#'
#' This function creates site-specific FAI, ranking, and DB format using data surveyed at the waterside.
...
FAI_WS <- function(filepath = NA){
    ...
    for(i in 1:length(site.list.a)){
        ...
        if("U00001" %in% subset.0$Species_Code | "U00002" %in% subset.0$Species_Code ){
            ...
            if(st.order == 1){
                M1 <- c(0,6.25,12.5)[cut(DS.R, breaks = c(-1,1,2,99))]
                M2 <- c(0,6.25,12.5)[cut(RB.R, breaks = c(-1,0,1,99))]
                M3 <- c(0,6.25,12.5)[cut(SS.R, breaks = c(-1,0,2,99))]
                M7 <- c(0,6.25,12.5)[cut(DS.A, breaks = c(-1,10,20,99999))]
            }else if(st.order == 2){

                M1 <- c(0,6.25,12.5)[cut(DS.R, breaks = c(-1,2,5,99))]
                M2 <- c(0,6.25,12.5)[cut(RB.R, breaks = c(-1,0,2,99))]
                M3 <- c(0,6.25,12.5)[cut(SS.R, breaks = c(-1,0,3,99))]
                M7 <- c(0,6.25,12.5)[cut(DS.A, breaks = c(-1,30,55,99999))]
            }else if(st.order == 3){

                M1 <- c(0,6.25,12.5)[cut(DS.R, breaks = c(-1,4,8,99))]
                M2 <- c(0,6.25,12.5)[cut(RB.R, breaks = c(-1,0,2,99))]
                M3 <- c(0,6.25,12.5)[cut(SS.R, breaks = c(-1,1,4,99))]
                M7 <- c(0,6.25,12.5)[cut(DS.A, breaks = c(-1,50,90,99999))]
            }else if(st.order == 4){

                M1 <- c(0,6.25,12.5)[cut(DS.R, breaks = c(-1,5,11,99))]
                M2 <- c(0,6.25,12.5)[cut(RB.R, breaks = c(-1,1,3,99))]
                M3 <- c(0,6.25,12.5)[cut(SS.R, breaks = c(-1,1,4,99))]
                M7 <- c(0,6.25,12.5)[cut(DS.A, breaks = c(-1,60,115,99999))]

            }else if(st.order == 5){

                M1 <- c(0,6.25,12.5)[cut(DS.R, breaks = c(-1,7,14,99))]
                M2 <- c(0,6.25,12.5)[cut(RB.R, breaks = c(-1,0,2,99))]
                M3 <- c(0,6.25,12.5)[cut(SS.R, breaks = c(-1,1,4,99))]
                M7 <- c(0,6.25,12.5)[cut(DS.A, breaks = c(-1,80,160,99999))]
            }else if(st.order == 6){

                M1 <- c(0,6.25,12.5)[cut(DS.R, breaks = c(-1,9,18,99))]
                M2 <- c(0,6.25,12.5)[cut(RB.R, breaks = c(-1,0,2,99))]
                M3 <- c(0,6.25,12.5)[cut(SS.R, breaks = c(-1,0,3,99))]
                M7 <- c(0,6.25,12.5)[cut(DS.A, breaks = c(-1,100,200,99999))]
            }else if(st.order == 7){

                M1 <- c(0,6.25,12.5)[cut(DS.R, breaks = c(-1,11,22,99))]
                M2 <- c(0,6.25,12.5)[cut(RB.R, breaks = c(-1,0,1,99))]
                M3 <- c(0,6.25,12.5)[cut(SS.R, breaks = c(-1,0,2,99))]
                M7 <- c(0,6.25,12.5)[cut(DS.A, breaks = c(-1,120,240,99999))]
            }
    ...
    species.n.a <- data.frame(matrix(nrow = length(site.list.a), ncol = 3)) #species number and abundance
    species.n.a[,1] <- site.list.a
    for(i in 1:length(site.list.a)){
        aa <-which(extract.abun.so.2$site_code == site.list.a[i])
        if(T %in% c(extract.abun.so.2$Species_Code[aa] %in% c("U00001","U00002"))){
            ...
            c(extract.abun.so.2$site_code == site.list.a[i]) |>
